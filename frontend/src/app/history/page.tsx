                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-blue-700">
                      {riskAnalysis.summary.route.origin_ports.join(', ')}
                    </p>
                  </div>
                  <div>
                    <span className="font-medium text-blue-800">Transit:</span>
                    <p className="text-blue-700">
                      {riskAnalysis.summary.route.transit.join(', ')}
                    </p>
                  </div>
                  <div>
                    <span className="font-medium text-blue-800">Destination:</span>
                    <p className="text-blue-700">
                      {riskAnalysis.summary.route.destination_ports.join(', ')}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-red-600">
                      {riskAnalysis.summary.overall_risk_profile.critical}
                    </div>
                    <div className="text-sm text-gray-600">Critical</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-orange-600">
                      {riskAnalysis.summary.overall_risk_profile.high}
                    </div>
                    <div className="text-sm text-gray-600">High</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-yellow-600">
                      {riskAnalysis.summary.overall_risk_profile.medium}
                    </div>
                    <div className="text-sm text-gray-600">Medium</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">
                      {riskAnalysis.summary.overall_risk_profile.low}
                    </div>
                  ...
                  {riskAnalysis.risks.map((risk, index) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span>Locations: {risk.locations_affected.join(', ')}</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="space-y-3">
                  {riskAnalysis.recommended_actions.map((action, index) => (
                    <div key={index} className="bg-green-50 border border-green-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-green-800">{action.details}</p>
                    </div>
                  ))}
                </div>
              </div>
